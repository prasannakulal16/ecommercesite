          ...
          <div className="text-center mt-52">
            ...
            <div className="text-center">
              <Link to="/">
                ...
                <span className="text-[16px] font-extralight pl-3 align-middle">
                  Start shopping
                </span>
              </Link>
            </div>
          ...
          <>
            ...
            <div className="">
              {cart.cartItems?.map((cartItem) => (
                <div
                  className="xl:grid sm:grid items-start grid-cols-5 gap-1 border-b-2 pb-5 pt-5"
                  key={cartItem.id}
                >
                  <div className="col-span-2 flex justify-self-start">
                    ...
                    <div className="ml-5">
                      ...
                      <p>{cartItem.desc}</p>
                      <button
                        className="border-[1px] border-slate-400 px-2 py-1 rounded-md hover:shadow-md hover:shadow-gray-600"
                  ...
                  <div className="xl:col-span-1 lg:mt-0 my-5">
                  ...
                  <div className="xl:col-span-1 flex justify-center w-28 border-slate-300 border-[1px] py-1 rounded-sm">
                    <button
                      ...
                      onClick={() => handleCartDecrement(cartItem)}
                    >
                    ...
                    <button
                      className="font-extrabold"
                      onClick={() => handleCartIncrement(cartItem)}
                    >
                      <PlusOutlined style={{ verticalAlign: "middle" }} />
                    </button>
                  </div>
                  <div className="col-span-1 text-right lg:text-left lg:mt-0 mt-5">
                    <h1 className="text-lg">
            ...
            <div className="xl:flex sm:flex justify-between mt-10 pb-10">
              <button
                className="border-[1px] border-slate-400 mt-8 rounded-md font-medium h-[40px] w-[138px] max-w-[100%] hover:shadow-md hover:shadow-gray-600 lg:my-0 mb-5"
              ...
              <div className="">
                <div className="flex justify-between">
                  ...
                  <span>INR {cart.cartTotalAmount}</span>
                </div>
                <p>Taxes and shipping calculated at checkout</p>
                <button className="block bg-blue-700 text-white rounded-sm w-[100%] py-3 mb-5 text-lg font-bold">
                  Check out
                </button>
                <Link to="/">
                  <LeftCircleFilled style={{ "font-size": "25px" }} />
                  <span className="pl-3 text-[16px] font-extralight align-middle">
                    Continue shopping
                  </span>
                </Link>
              </div>
